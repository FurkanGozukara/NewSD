...
from diffusers.loaders.unet import FromOriginalUNetMixin
...
class GlobalResponseNorm(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.gamma.to(stand_div_norm.dtype) * (x * stand_div_norm) + self.beta.to(stand_div_norm.dtype) + x
