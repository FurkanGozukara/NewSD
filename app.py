...
with gr.Blocks() as app:
    gr.Markdown(""" ### Stable Cascade V9 by SECourses : 1-Click Installers Latest Version On : https://www.patreon.com/posts/98410661 
    ...
    with gr.Tab("Image Generation"):
        ...
        run_button.click(fn=generate, inputs=[
            ...
            batch_size_per_prompt, number_of_images_per_prompt, randomize_seed_ck
        ], outputs=[result, seed])
    ...
    with gr.Tab("Image Metadata"):
        ...
        set_metadata_button.click(fn=set_metadata_settings, inputs=[metadata_image_input], outputs=[
            prompt, negative_prompt, seed, width, height,
            prior_guidance_scale,
             decoder_guidance_scale, prior_num_inference_steps, decoder_num_inference_steps,
