...
class StableCascadePriorPipelineV2(DiffusionPipeline):
    """
    ...
    def __call__(
        ...
        latents = self.prepare_latents(
            batch_size, height, width, num_images_per_prompt,  prompt_embeds.dtype, device, generator, latents, self.scheduler
        )
